...
var playerXScore = 0;
var playerOScore = 0;
var scoreXElement = document.querySelector(".nguoichoi_X p");
var scoreOElement = document.querySelector(".nguoichoi_O p");
...
function play(y) {
    ...
    if (y.dataset.player == "none" && window.isGameOver == false) {
        ...
        // Chơi âm thanh khi người chơi thực hiện nước đi
        playMoveSound();
        if (playerTurn == "x") {
            playerTurn = "o";
...
function gameOver(a) {
    ...
    scoreXElement.textContent = "Score X: " + playerXScore;
    scoreOElement.textContent = "Score O: " + playerOScore;
